...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    # Print Summary of Results statistics 
    print(f'Results for architecture: {model}')
    ...
    print(f'% Match (both dogs and "not-a" dog): {results_stats_dic["pct_match"]}')
